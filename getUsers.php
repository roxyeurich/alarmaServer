...
$query = "SELECT id, username, users.latitude, users.longitude, (SELECT SUM(score) FROM tasks WHERE user_id=users.id) AS score FROM users WHERE group_id='$group_id', ORDER BY DESC";
